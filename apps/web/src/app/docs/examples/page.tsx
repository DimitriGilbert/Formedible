              ...
              <TabsContent value="analytics">
                ...
                >
                  <DemoCard
                    ...
                    preview={
                      <analyticsTrackingForm.Form className="space-y-4" />
                    }
              ...
              <TabsContent value="conditional-pages">
                ...
                >
                  <DemoCard
                    ...
                    preview={<conditionalPagesForm.Form className="space-y-4" />}
                    code={`const conditionalPagesForm = useFormedible({
  schema: conditionalPagesSchema,
  fields: [
    // Page 1 - Application Type (always shown)
    {
    ...
    // Page 2 - Individual Info (only shown for individual applications)
    {
      ...
      label: "First Name",
      page: 2,
      conditional: (values) => values.applicationType === "individual",
    },
    ...
    // Page 3 - Business Info (only shown for business applications)
    {
      ...
      label: "Company Name",
      page: 3,
      conditional: (values) => values.applicationType === "business",
    },
    // ... more business fields

    // Page 5 - Premium Options (conditionally shown)
    {
      name: "premiumFeatures",
      type: "multiSelect",
      label: "Which premium features interest you?",
      page: 5,
      conditional: (values) => values.needsPremium === true,
      // ... options
    },
  ],
  pages: [
    ...
    },
    {
      ...
      title: "Personal Information",
      description: "Tell us about yourself",
      // This entire page is conditionally shown!
      conditional: (values) => values.applicationType === "individual",
    },
    {
      page: 3,
    ...
    },
    {
      ...
      title: "Premium Options",
      description: "Customize your premium experience",
      // This page only appears if premium is selected
      conditional: (values) => values.needsPremium === true,
    },
    // ... more pages
  ],
              ...
              <TabsContent value="advanced-fields">
                ...
                >
                  <DemoCard
                    ...
                    preview={
                      <advancedFieldTypesForm.Form className="space-y-4" />
                    }
