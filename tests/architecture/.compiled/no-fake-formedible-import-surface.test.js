...
import { assertNoViolations, assertHasViolations, collectRepositoryEntries, collectRepositoryTextFiles, extractImportSpecifiers, } from './utils.js';
...
export function findFakeFormedibleImportViolations(files) {
    return files.flatMap((file) => extractImportSpecifiers(file.content)
