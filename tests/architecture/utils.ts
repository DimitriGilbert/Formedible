...
export const pinnedGeneratedFilePaths: readonly string[] = [...ignoredGeneratedFilePaths];

export function isIgnoredGeneratedFilePath(relativePath: string): boolean {
...
export function isFileWritingScript(file: RepositoryFile): boolean {
...
export async function listIgnoredGeneratedFilePaths(): Promise<string[]> {
...
async function walkRepository(
  visitEntry: ((entry: RepositoryEntry) => void) | undefined,
  visitIgnored?: (relativePath: string) => void,
): Promise<void> {
