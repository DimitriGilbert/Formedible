...
export const AutocompleteField: React.FC<AutocompleteFieldProps> = ({
  ...
  const filterStaticOptions = (query: string): AutocompleteOption[] => {
  ...
  const fetchAsyncOptions = async (query: string) => {
  ...
  }, [inputValue, asyncOptions, debounceMs, minChars, maxResults, options]);
