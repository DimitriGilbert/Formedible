...
interface SliderFieldProps<TFormValues extends Record<string, unknown>> 
  extends Omit<React.ComponentProps<typeof Slider>, 'name' | 'defaultValue' | 'value' | 'onValueChange' | 'onBlur' | 'form'> {
  form: FormApi; 
...
export function SliderField<TFormValues extends Record<string, unknown>>({
  form,
  name,
  label,
  valueLabelPrefix = '',
